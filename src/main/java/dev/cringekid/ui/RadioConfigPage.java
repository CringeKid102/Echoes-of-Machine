...
import dev.cringekid.manager.PlaybackSession;
...
public class RadioConfigPage extends InteractiveCustomUIPage<RadioConfigPage.RadioPageData> {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder,
        ...
        if (library != null) {
            ...
            for (dev.cringekid.manager.MediaLibrary.SavedSong song : library.getSongsForPlayer(libraryOwnerId)) {
