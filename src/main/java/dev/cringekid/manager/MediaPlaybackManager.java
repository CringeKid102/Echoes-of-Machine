...
import dev.cringekid.MediaRadioPlugin;
import dev.cringekid.util.RadioItemUtil;
import dev.cringekid.util.VolumeUtil;
...
public class MediaPlaybackManager {
    ...
    public void updateComponent(Vector3i pos, Store<EntityStore> store,
            java.util.function.Consumer<dev.cringekid.component.RadioComponent> updater) {
        ...
        chunkStore.getStore().ensureComponent(blockRef, dev.cringekid.component.RadioComponent.COMPONENT_TYPE);
        dev.cringekid.component.RadioComponent component = chunkStore.getStore()
                .getComponent(blockRef, dev.cringekid.component.RadioComponent.COMPONENT_TYPE);
        if (component == null) {
            return;
        }
    ...
    private Ref<ChunkStore> getOrCreateBlockEntityRef(ChunkStore chunkStore, Vector3i pos) {
        ...
        holder.ensureComponent(dev.cringekid.component.RadioComponent.COMPONENT_TYPE);
